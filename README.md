# BoingAI Studio <img src="other/assets/logo.png" width="45" height="45" alt="Icon">
...
![BoingAI Screenshot](/other/assets/screenshot.png) <!-- Optional: Add a screenshot of your app -->
